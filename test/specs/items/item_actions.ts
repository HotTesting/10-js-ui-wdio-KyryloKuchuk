...
function cleanStoragesAndCookies () {
...
function loginByUi(user) {
    ...
    cleanStoragesAndCookies()
    const topMenu = $('.container');
    console.log('Open dropdown');
    const myAccountDropDown = topMenu.$(' .dropdown');
    myAccountDropDown.click()
    browser.pause(1000);
    console.log('Click login in dropdown');
    const loginButtonFromDropDown = myAccountDropDown.$('.dropdown-menu a[href$="login"]');
...
function logoutByUi() {
    ...
    const logoutButton = myAccountDropDown.$('.dropdown-menu a[href$="logout"]');
    logoutButton.click();
    browser.pause(1000);
    expect(browser).toHaveUrl(`${browser.config.baseUrl}/index.php?route=account/logout`);
    cleanStoragesAndCookies();
};
